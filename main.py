...
def parse_args(argv=None):
    ...
    # base45-lab
    parser_b45 = subparsers.add_parser(
        "base45-lab", aliases=["base45", "b45"],
        help="Base45 encode and decode strings."
    )
    b45_group = parser_b45.add_mutually_exclusive_group(required=False)
    b45_group.add_argument("--encode", "-e", type=str, help="Text to Base45 encode.")
    b45_group.add_argument("--decode", "-d", type=str, help="Base45 text to decode.")
    parser_b45.add_argument("--tui", action="store_true", help="Launch interactive TUI for Base45 Lab.")
