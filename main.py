...
KNOWN_COMMANDS = [
    ...
    "ical-lab", "ical", "ics",
    "markdown-lab", "md", "md-lab", "yaml-lab", "yaml", "ini-lab", "ini", "toml-lab", "toml", "net-lab", "net", "archive-lab", "arc", "ini2json-lab", "ini2json", "i2j",
...
# --- New 'argon2-lab' command ---
    ...
    parser_ini2json = subparsers.add_parser(
        ...
        help="Convert INI format to JSON."
    )
    parser_ini2json.add_argument("--file", "-f", help="Input INI file.")
    parser_ini2json.add_argument("--text", "-t", help="Input INI string.")
    parser_ini2json.add_argument("--output", "-o", help="Output JSON file path.")
    parser_ini2json.add_argument("--tui", action="store_true", help="Launch interactive TUI.")
