...
class TestCherryPickCommand(unittest.TestCase):
    ...
    def test_cherry_pick_invalid_ref(self, mock_stderr, mock_stdout):
        """Test cherry-picking with a malicious or invalid git reference."""
        args = MagicMock()
        args.project_dir = self.test_dir
        # This input could be used for command injection if not sanitized
        args.target = ";-echo 'malicious code'"
