...
class TestOtpLabTab(unittest.IsolatedAsyncioTestCase):
    ...
    def test_generate_secret_success(self):
        ...
        self.tab.notify.assert_called_with("Secret generated.")
    ...
    def test_generate_secret_invalid(self):
        ...
        self.tab.notify.assert_called_with("Invalid length.", severity="error")
    ...
    def test_start_monitoring(self):
        ...
        self.tab.set_interval.assert_called_once()
