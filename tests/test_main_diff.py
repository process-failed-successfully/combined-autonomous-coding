...
from main import get_parser, run_diff
...
class TestDiffCommand(unittest.TestCase):
    ...
    def test_diff_uncommitted_changes(self, mock_subprocess_run):
        ...
        parser = get_parser()
        args = parser.parse_args(['diff', '--project-dir', str(self.project_dir)])
    ...
    def test_diff_with_run_id(self, mock_subprocess_run, mock_find_commit):
        ...
        parser = get_parser()
        args = parser.parse_args(['diff', run_id, '--project-dir', str(self.project_dir)])
    ...
    def test_diff_with_commit_hash(self, mock_subprocess_run):
        ...
        parser = get_parser()
        args = parser.parse_args(['diff', commit_hash, '--project-dir', str(self.project_dir)])
    ...
    def test_diff_invalid_target(self, mock_subprocess_run, mock_find_commit):
        ...
        parser = get_parser()
        args = parser.parse_args(['diff', invalid_target, '--project-dir', str(self.project_dir)])
