...
# Mock kafka module before importing shared.kafka_lab
...
class TestKafkaLabManager(unittest.TestCase):
    ...
    def test_list_topics(self, mock_consumer_cls):
    ...
    @patch("shared.kafka_lab.KafkaConsumer")
    def test_describe_topic(self, mock_consumer_cls):
        mock_consumer = mock_consumer_cls.return_value
    ...
    def test_create_topic(self, mock_admin_cls):
    ...
    def test_produce(self, mock_producer_cls):
    ...
    @patch("shared.kafka_lab.KafkaConsumer")
    def test_consume_messages(self, mock_consumer_cls):
        mock_consumer = mock_consumer_cls.return_value
