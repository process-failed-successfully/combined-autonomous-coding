...
def find_duplicates(project_dir: Path, file_patterns: Optional[List[str]] = None, ignore_patterns: Optional[List[str]] = None, min_tokens: int = 50) -> List[Dict[str, Any]]:
    """
    ...
    results.sort(key=lambda x: int(x['token_count']), reverse=True)
