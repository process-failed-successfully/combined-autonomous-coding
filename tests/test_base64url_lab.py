...
class TestBase64UrlLab(unittest.TestCase):
    ...
    def test_encode(self, mock_print):
        ...
        # base64.urlsafe_b64encode(b"hello") -> b"aGVsbG8=" -> stripped -> "aGVsbG8"
    ...
    def test_tui_launch(self, mock_exit):
        ...
        from main import run_base64url_lab
        args = argparse.Namespace(command="base64url-lab", encode=None, decode=None, tui=True, project_dir=".", _in_event_loop=False)
        ...
        mock_agent_tui.assert_called_with(project_dir=".", start_tab="tab-base64url")
