...
class TestWorktreesCommand(unittest.TestCase):
    ...
    def test_worktree_create(self):
        parser = get_parser()
        args = parser.parse_args(["worktrees", "create", "test-worktree", "-p", str(self.project_dir)])
    ...
    def test_worktree_list(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "list", "-p", str(self.project_dir)])
    ...
    def test_worktree_show_sprint_worktree(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "show", worktree_name, "-p", str(self.project_dir)])
    ...
    def test_worktree_show_non_existent_worktree(self):
        parser = get_parser()
        args = parser.parse_args(["worktrees", "show", "non-existent-worktree", "-p", str(self.project_dir)])
    ...
    def test_worktree_clean(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "clean", "test-worktree", "-p", str(self.project_dir), "-y"])
        with patch("sys.exit") as mock_exit:
            from main import run_worktrees
            run_worktrees(args)
            mock_exit.assert_called_once_with(0)
    ...
    def test_worktree_revert(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "revert", "test-worktree", "-p", str(self.project_dir), "-y"])
        with patch("sys.exit") as mock_exit:
            from main import run_worktrees
            run_worktrees(args)
            mock_exit.assert_called_once_with(0)
    ...
    def test_worktree_merge(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "merge", "test-worktree", "-p", str(self.project_dir), "--clean", "-y"])
        with patch("sys.exit") as mock_exit:
            from main import run_worktrees
            run_worktrees(args)
            mock_exit.assert_called_once_with(0)
    ...
    def test_worktree_diff(self):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "diff", "test-worktree", "-p", str(self.project_dir)])
        with patch("sys.exit") as mock_exit, patch("builtins.print") as mock_print:
            from main import run_worktrees
            run_worktrees(args)
            mock_exit.assert_called_once_with(0)
    ...
    def test_worktree_manage_show(self, mock_input):
        ...
        parser = get_parser()
        args = parser.parse_args(["worktrees", "manage", "-p", str(self.project_dir)])
        with patch("sys.exit") as mock_exit, patch("builtins.print") as mock_print:
            from main import run_worktrees
            run_worktrees(args)
            mock_exit.assert_called_once_with(0)
