...
2. Use standard tools (write files, run commands, etc.).
3. When you have completed the task and verified it (if possible), you MUST signal completion.
4. To signal completion, output the specific line: `SPRINT_TASK_COMPLETE` on its own line.
5. If you are blocked or fail, output: `SPRINT_TASK_FAILED: <reason>`.
