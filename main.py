...
def run_commands(args):
    ...
    print_command("commands", "Show this structured list of all commands.")
...
def parse_args(argv=None):
    ...
    parser_commands = subparsers.add_parser("commands", help="Show a structured and user-friendly list of all commands.")
