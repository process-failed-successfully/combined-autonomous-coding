...
KNOWN_COMMANDS = [
    ...
    "bson-lab", "bson",
    "csv2md-lab", "csv2md", "yaml2json-lab", "yaml2json", "y2j", "yaml2toml-lab", "yaml2toml", "toml2yaml", "excel-lab", "xls", "xlsx", "excel", "template-lab", "tpl", "image-lab", "img", "exif-lab", "exif", "ocr-lab", "ocr", "media-lab", "media", "xml-lab", "xml", "lorem-lab", "lorem", "lipsum",
...
async def main():
    ...
    if args.command in ["yaml2toml-lab", "yaml2toml", "toml2yaml"]:
        if getattr(args, "action", None) == "tui":
