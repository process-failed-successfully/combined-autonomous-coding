...
from shared.analytics import get_git_contributors, get_git_hotspots, get_git_activity, collect_analytics_data
...
class TestAnalytics(unittest.TestCase):
    ...
    def test_collect_analytics_data(self, mock_scan_secrets, MockUnused, mock_duplication, mock_complexity, mock_todos):
        ...
        data = collect_analytics_data(Path("/tmp/test_project"))
