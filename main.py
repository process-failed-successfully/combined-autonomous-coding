...
def run_cherry_pick(args):
    ...
    is_git_ref = False
    try:
        # Use rev-parse to robustly check if the target is a commit-like object.
        # The '^{commit}' suffix ensures that we're dealing with a commit,
        # not just a tag or other ref.
    ...
    try:
        ...
        # Use '--' to ensure the target is treated as a positional argument and not an option
