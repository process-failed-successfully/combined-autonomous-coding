...
# Mock tab for unrelated tabs
class MockTab(Container):
    def __init__(self, project_dir=None, **kwargs):
        # Do not pass project_dir to Container.__init__ as it expects Widgets
...
class TestTUIDocs(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        self.patches = [
            ...
            # CRITICAL: Patch unrelated tabs to avoid initialization errors
            ...
            patch('shared.tui.I18nTab', MockTab),
