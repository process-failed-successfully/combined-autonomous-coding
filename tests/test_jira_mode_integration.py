...
class TestJiraModeIntegration(unittest.TestCase):
    ...
    def test_main_with_jira_ticket(self, mock_exit, mock_parse_args, mock_jira_class, mock_run_agent, mock_load_config, mock_ensure_config):
        """
        ...
        mock_args.max_error_wait = 600.0
        ...
        # 3. Setup Config Loader Mock
        mock_load_config.return_value = {
            "jira": {
                "url": "http://jira.mock", "email": "test@test.com", "token": "secret"
            }
        }
    ...
    @patch("main.parse_args")
    @patch("sys.exit", new_callable=MagicMock)
    def test_main_with_jira_label(self, mock_exit, mock_parse_args, mock_jira_class, mock_run_agent, mock_load_config, mock_ensure_config):
