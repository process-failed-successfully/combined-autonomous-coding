...
class TestMathLabTab(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        self.notify_patch = patch.object(self.tab, 'notify')
        self.mock_notify = self.notify_patch.start()

        self.query_one_patch = patch.object(self.tab, 'query_one')
        self.mock_query_one = self.query_one_patch.start()

    async def asyncTearDown(self):
        self.patcher.stop()
        self.notify_patch.stop()
        self.query_one_patch.stop()
